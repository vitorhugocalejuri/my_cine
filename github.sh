...
export name='Vitor Hugo Calejuri'
export email="vitor.silva1160@etec.sp.gov.br"
export repositorio="https://github.com/vitorhugocalejuri/my_cine.git";

#Daqui pra baixo mexa somente se for realmente necessário ou se souber o que está fazendo :P

export branch_name="my_cine-$(date +%d%m%Y-%H%M%S)"
